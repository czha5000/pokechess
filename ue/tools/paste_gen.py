...
# Windows 上 python3 的 stdout/stderr 默认走 cp1252,输出中文(节点注释、帮助文本、
# 校验报错)会直接抛 UnicodeEncodeError。这个坑 UE协作Harness规范.md 1.5 节已记录过
# (.claude/hooks/*.py 全部踩过并用同一手法修掉),本脚本原本写于 Linux 云端环境没遇上。
