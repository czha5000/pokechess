...
const LEARN={
  fire:['basic','ember','heavy'], water:['basic','aqua','heal'],
  grass:['basic','vine','sweep'], electric:['basic','spark','heavy'],
  ghost:['basic','shadow','sweep'], normal:['basic','reckless'],
  flying:['basic','gust','bravebird'], fighting:['basic','chop','reckless'],
  rock:['basic','rockthrow','heavy'], poison:['basic','sludge'], dark:['basic']
};
